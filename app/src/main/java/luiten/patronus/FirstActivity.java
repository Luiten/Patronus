...
public class FirstActivity extends MainActivity implements CameraBridgeViewBase.CvCameraViewListener2, SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Start
        Button button1 = (Button)findViewById(R.id.first_btn_start);
        ...
        // Setting
        Button button3 = (Button)findViewById(R.id.first_btn_setting);
        ...
        // Stop
        Button button4 = (Button)findViewById(R.id.first_btn_exit);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        TextView tv = (TextView)findViewById(R.id.first_text_speed);
